...
class Cube(object):
    ...
    def get_obj_central_pixels(self):
        """ If the centre coordinates of the object are provided, 
        this function will return the corresponding pixels values"""
...
class MANGACube(Cube):
    ...
    def get_eff_radius(self):        
        ...
        self.eff_radius_physical = angular_distance*self.eff_radius/3600 * np.pi/180 *1000 #kpc
